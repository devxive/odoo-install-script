#!/bin/bash
################################################################################
# Script for Installation: ODOO V8.0/Trunk server on Ubuntu 14.04.2 LTS
# Author: Lahmizzar Valeryon, devXive 2015
#
# based on openerp-install-scripts, created by Andre Aschenkels, ICTSTUDIO 2014
# https://github.com/aschenkels-ictstudio/openerp-install-scripts
#-------------------------------------------------------------------------------
#
# This script will install ODOO Server on
# clean Ubuntu 14.04.2 Server
#-------------------------------------------------------------------------------
# USAGE:
#
# odoo-install
...
#Version to checkout from Github repository. Eg. "8.0" for version 8.0 or "master" for trunk
OE_VERSION="8.0"
